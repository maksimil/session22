...
\begin{align*}
	 ...
	 & \exists \text{наибольшее }n_i\Rarr B \text{ --- конечно, иначе --- счётно}\;\square.
\end{align*}
...
Нумеруя $\bigcup_i A_i$ по диагонали мы получаем $f:\bigcup_i A_i\leftrightarrow\N\;\square.$
...
\begin{align*}
	...
	A:=\setdef{a_i}{i\in\N}       & \subset M\;\square.                             \\
\end{align*}
