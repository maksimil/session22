...
\begin{minipage}{0.6\linewidth}
	...
	\begin{align*}
		\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}=1\Rarr y^{2}
		 & =b^{2}-x^{2}\frac{b^{2}}{a^{2}}=a^{2}-c^{2}-x^{2}\frac{a^{2}-c^{2}}{a^{2}}= \\
		 & =a^{2}-c^{2}-x^{2}+x^{2}\frac{c^{2}}{a^{2}}
	\end{align*}
\end{minipage}%
...
\begin{align*}
	r_1 & =d(F_1, M)=\sqrt{(x+c)^{2}+y^{2}}=\sqrt{x^{2}+2xc+c^{2}+a^{2}-c^{2}-x^{2}+x^{2}\frac{c^{2}}{a^{2}}}=                        \\
	    & =\sqrt{a^{2}+2xc+x^{2}\frac{c^{2}}{a^{2}}}=\left|a+\frac{xc}{a}\right|=|a+\eps x|=a+\eps x\text{, тк }\eps<1\land |x|\leq a \\
	r_2 & =d(F_2, M)=\sqrt{(x-c)^{2}+y^{2}}=\sqrt{a^{2}-2xc+x^{2}\frac{c^{2}}{a^{2}}}=\left|a-\frac{xc}{a}\right|=|a-\eps x|=a-\eps x
\end{align*}
